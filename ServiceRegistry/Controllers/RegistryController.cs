...
namespace SimpleWebAPI.Controllers
{
    ...
    public class RegistryController : ApiController
    {
        ...
        public RegistryOBJ Search(int authToken,string searchText)
        {
            ...
            {
                using (StreamReader r = new StreamReader(@"C:\Users\R E V O\Desktop\Assignment 1\ServiceRegistry.txt"))
                {
        ...
        */
        ...
        public RegistryOBJ Post([FromUri()] int authToken,[FromBody] RegistryOBJ obj)
        {
            ...
            if (validator.Validate(authToken))
            {
                ...
                using (StreamWriter file = File.CreateText(@"C:\Users\R E V O\Desktop\Assignment 1\ServiceRegistry.txt"))
                {
